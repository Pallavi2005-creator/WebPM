          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">WebPM</span>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
                  Get more done with{' '}
                  <span className="text-blue-600">WebPM</span>
                </h1>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-800 rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="h-16 bg-gray-700 rounded flex items-end justify-center space-x-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Invite your team</h3>
              <p className="text-gray-600">
      ...
      <section className="bg-blue-600 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of teams that use WebPM to get more done, together.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/sign-in">
              <Button 
                size="lg" 
                variant="outline" 
                className="border-white text-blue-600 hover:bg-gray-100 hover:text-blue-600 px-8 py-3"
              >
                Sign In
              </Button>
            </Link>
      ...
      <footer className="bg-white border-t py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t pt-8 mt-8 text-center text-gray-600">
            <p>&copy; 2025 WebPM. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
